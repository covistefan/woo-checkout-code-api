    ...
    <table class="form-table wcca-table-outer product-fee-table">
        <tbody>
            ...
            <tr valign="top">
                ...
                <td>
                    <select name = "wcca_submit_field" class="multiselect2">
                    <?php 
            ...
            <tr valign="top">
                ...
                <td>
                    <select name = "wcca_curl_field" class="multiselect2">
                    <?php 
            ...
            <tr valign="top">
                <th class="titledesc" scope="row">
                    <label><?php esc_html_e( 'Select data return type', WCCA_TEXT_DOMAIN ); ?></label>
                </th>
                <td>
                    <select name = "wcca_return_field" class="multiselect2">
                    <?php 
