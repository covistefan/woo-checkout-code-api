        ...
        <tbody>
            <tr valign="top">
                ...
                <td><?php 
                    ...
                    echo  '<select name = "wcca_auth_field" class="multiselect2" onchange="showhideAuthRow(this.value);">' ;
            ...
            <tr class="auth_data" <?php echo ($selectedAuth==0) ? ' style="display: none;" ' : '' ; ?>>
                <th class="titledesc" scope="row">
                    <label class="basic_user" <?php echo ($selectedAuth!=1) ? ' style="display: none;" ' : '' ; ?>><?php esc_html_e( 'Auth user', WCCA_TEXT_DOMAIN ); ?></label>
                    <label class="api_client" <?php echo ($selectedAuth!=2) ? ' style="display: none;" ' : '' ; ?>><?php esc_html_e( 'API-Client', WCCA_TEXT_DOMAIN ); ?></label>
                </th>
                <td class="forminp mdtooltip">
                    <label>
            ...
            <tr class="auth_data" <?php echo ($selectedAuth==0) ? ' style="display: none;" ' : '' ; ?>>
                <th class="titledesc" scope="row">
                    <label class="basic_user" <?php echo ($selectedAuth!=1) ? ' style="display: none;" ' : '' ; ?>><?php esc_html_e( 'Auth pass', WCCA_TEXT_DOMAIN ); ?></label>
                    <label class="api_client" <?php echo ($selectedAuth!=2) ? ' style="display: none;" ' : '' ; ?>><?php esc_html_e( 'API-Key', WCCA_TEXT_DOMAIN ); ?></label>
                </th>
                <td class="forminp mdtooltip">
                    <label>
